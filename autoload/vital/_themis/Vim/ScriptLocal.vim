...
execute join(['function! vital#_themis#Vim#ScriptLocal#import() abort', printf("return map({'scriptnames': '', 'sid2path': '', 'sid2sfuncs': '', 'sfuncs': '', 'svars': '', 'sid': '', 'sid2svars': ''}, \"vital#_themis#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
